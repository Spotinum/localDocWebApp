            ...
            steps {
                sh '''
                   # replace dbserver in host_vars
                     ...
                     sed -i 's/192.168.56.101/20.0.152.18/g' ~/workspace/ansible/groups_vars/appservers.yaml
                     sed -i 's/192.168.56.103/20.0.152.18/g' ~/workspace/ansible/groups_vars/appservers.yaml
                '''
                sh '''
